    ...
    return this.get('ajax').patch('/workouts/' + entry.id, {
      data: {
        workout: {
          ...
          exercise1weight: entry.exercise1weight,
          ...
          exercise2weight: entry.exercise2weight,
          ...
          exercise3weight: entry.exercise3weight,
          ...
          exercise4weight: entry.exercise4weight,
          ...
          exercise5weight: entry.exercise5weight,
          ...
          exercise6weight: entry.exercise6weight,
          ...
          exercise7weight: entry.exercise7weight,
          ...
          exercise8weight: entry.exercise8weight,
          ...
          exercise9weight: entry.exercise9weight,
          ...
          exercise10weight: entry.exercise10weight,
